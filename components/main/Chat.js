...
function Chat(props) {
    ...
    return (
        <ScrollView style={{height:screenHeight,width:screenWidth, flex:1, backgroundColor:'white',fontFamily:'logo-font',borderBottomColor:'lightgrey', borderBottomWidth:0.5,position:'absolute'}}>
                <FlatList
